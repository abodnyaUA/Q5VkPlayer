...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SettingsController_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 39, 9)
    ...
    "SettingsController\0settingsDidUpdated\0"
    "\0setVolume\0"
};
...
void SettingsController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->settingsDidUpdated(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SettingsController::settingsDidUpdated)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject SettingsController::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_SettingsController.data,
      qt_meta_data_SettingsController,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SettingsController.stringdata))
...
// SIGNAL 0
void SettingsController::settingsDidUpdated()
{
